-- INSERT INTO customers -- optionally, you can specify which columns you wanna insert data into, and then insert to just those cols, and you can mix up the orders.
-- VALUES (DEFAULT,
-- 		'John',
--         'Smith',
--         '1990-01-01',
--         NULL, -- or DEFAULT cause default is NULL in this table!
-- 		'address',
--         'city',
--         'CA',
--         DEFAULT);
...
-- VALUES (1, '2019-01-02', 1); -- need to insert valid customerID && status!
...
-- VALUES (LAST_INSERT_ID(), 1, 1, 2.95), -- LAST_INSERT_ID: will return the id that mysql generates when we insert a new row.
...
-- CREATE TABLE orders_archived AS -- using this method, you can copy a table's data but not the primary key, auto increment, and stuffs like that, like the configuration!
-- SELECT * FROM orders -- this select statement is a subquery- a select statement that is a part of another SQL statement!
